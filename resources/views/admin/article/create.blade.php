        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    ...
                    <form action="/admin/article" class="am-form tpl-form-border-form" method="post">
                        @csrf
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-12">
                                <input type="text" name="title" value="{{old('title')}}" class="am-form-field tpl-form-no-bg am-margin-top-xs" placeholder="请填写标题" required>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-12">
                                <input type="number" name="coins" value="{{old('coins')}}" class="am-form-field tpl-form-no-bg am-margin-top-xs" placeholder="请设置发币" required>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-12">
                                <textarea name="description" cols="30" rows="5" placeholder="请输入文章描述" required></textarea>
                            </div>
                        </div>
