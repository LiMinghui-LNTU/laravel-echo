        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    ...
                    <form action="/admin/vip/{{$oVip->id}}" class="am-form tpl-form-border-form" method="post">
                        @csrf
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-12">
                                <input type="text" name="title" class="am-form-field tpl-form-no-bg am-margin-top-xs" value="{{$oVip->title}}" required>
                                <small>请设置会员名称。</small>
                            </div>
                        </div>
                            ...
                            <div class="am-u-sm-12 am-margin-top-xs">
                                <div class="am-form-group am-form-file">
                                    <div class="tpl-form-file-img">
                                        <img id="show_thumb" width="200" src="{{$oVip->picture}}">
                                        <input type="hidden" id="hide_thumb" name="picture" value="{{$oVip->picture}}" required>
                                    </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-3">
                                <input type="number" name="charge" class="am-form-field tpl-form-no-bg am-margin-top-xs" placeholder="填写办理费用" min="0" value="{{$oVip->charge}}" required>
                                <small>办理此会员需要交纳的费用。</small>
                            </div>
                            <div class="am-u-sm-3">
                                <input type="number" name="discount" class="am-form-field tpl-form-no-bg am-margin-top-xs" placeholder="请设置消费折扣" min="0" value="{{$oVip->discount}}" required>
                                <small>消费时按该折扣进行打折。</small>
                            </div>
                            <div class="am-u-sm-3">
                                <input type="number" name="reputation_value" class="am-form-field tpl-form-no-bg am-margin-top-xs" placeholder="请设置奖励信誉值" min="0" value="{{$oVip->reputation_value}}" required>
                                <small>办理该会员的顾客将会得到此信誉值奖励。</small>
                            </div>
                            <div class="am-u-sm-3">
                                <input type="number" name="coins" class="am-form-field tpl-form-no-bg am-margin-top-xs" placeholder="请设置奖励的发币" min="0" value="{{$oVip->coins}}" required>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-12">
                                <input type="text" name="privilege" class="am-form-field tpl-form-no-bg am-margin-top-xs" value="{{$oVip->privilege}}" required>
