        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    ...
                    <form action="/admin" class="am-form tpl-form-border-form" method="post">
                        @csrf
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-12">
                                <input type="text" class="tpl-form-input am-margin-top-xs" id="username" name="username" value="{{old('username')}}" placeholder="请输入用户名" required>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-12">
                                <input type="password" class="tpl-form-input am-margin-top-xs" id="password" name="password" placeholder="******" required>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-12">
                                <label class="am-radio-inline">
                                    <input type="radio" name="role_id" value="1" required data-am-ucheck>管理员
                                </label>
                                <label class="am-radio-inline">
                                    <input type="radio" name="role_id" value="2"  required data-am-ucheck>店长
                                </label>
                                <br>
                                <small>分配管理者角色。</small>
                            </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-12">
                                <input type="email" name="email" class="am-form-field tpl-form-no-bg am-margin-top-xs" value="{{old('email')}}" placeholder="请输入邮箱">
                                <small>非必填。</small>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-12">
                                <input type="number" name="phone" class="am-form-field tpl-form-no-bg am-margin-top-xs" value="{{old('phone')}}" placeholder="请输入电话">
                                <small>非必填。</small>
                            </div>
                        </div>
