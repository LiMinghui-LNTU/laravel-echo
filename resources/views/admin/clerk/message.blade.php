                ...
                <div class="widget am-cf">
                    ...
                    <div class="widget-body  am-fr">
                        ...
                        <div class="am-panel-bd am-u-md-12">
                            <ul class="am-comments-list am-comments-list-flip am-scrollable-vertical" id="clerk-ul" style="height: 450px;">
                                @if($oMyMessages)
                            ...
                            <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                <input type="text" id="message-content-clerk" class="am-form-field" placeholder="请输入回复内容：">
                                <span class="am-input-group-btn">
                                    <button class="am-btn  am-btn-default am-btn-danger tpl-table-list-field am-icon-reply" type="button" onclick="clerkSend();">回复</button>
...
<script>
    function clerkSend() {
        var content = $("#message-content-clerk").val();
        if (content.trim() == '') {
            $("#message-content-clerk").focus();
            return false;
        } else {
            $.post(
                '/admin/admin-reply',
