                    ...
                    <ul class="news-content-ul">
                        <li class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                            <a href="/activity">
                                <div class=" am-u-sm-12 am-u-md-12 am-u-lg-5">
                                    <div class="news-img">
                                        <img src="{{$oTicket1->picture}}" />
                                    </div>
                                </div>
                                <div class=" am-u-sm-12 am-u-md-12 am-u-lg-7">
                                    <span class="news-right-title">新人福利</span>
                                    <p class="news-right-time">开始时间：{{$oTicket1->created_at}}</p>
                                    <p class="news-right-words">{{$oTicket1->condition}}</p>
                                </div>
                                <div class="clear"></div>
                            </a>
                        </li>
                        <li class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                            <a href="#">
                                <div class=" am-u-sm-12 am-u-md-12 am-u-lg-5">
                                    <div class="news-img">
                                        <img src="{{$oTicket2->picture}}" />
                                    </div>
                                </div>
                                <div class=" am-u-sm-12 am-u-md-12 am-u-lg-7">
                                    <span class="news-right-title">限时活动</span>
                                    <p class="news-right-time">开始时间：{{$oTicket2->created_at}}</p>
                                    <p class="news-right-words">{{$oTicket2->condition}}</p>
                                </div>
                                <div class="clear"></div>
                            </a>
                        </li>
